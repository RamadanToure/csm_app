                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('matricule','',["id"=>"matricule","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre grade",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
						            ...
						            {!! Form::select('type_destina',trans('entite.type_destinataire') ,null,["id"=>"type_destina","class"=>"form-select select2",'required'=>'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="id_fonct" class="form-label">{{trans('data.id_fonct')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::select('id_desti',[],null,["id"=>"id_desti","class"=>"form-select allselect","required"=>"required"]) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="grade" class="form-label">{{trans('data.grade')}}</label>
                                    {!! Form::text('grade','',["id"=>"grade","class"=>"form-control",'placeholder'=>"Entrer votre grade",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="echellon" class="form-label">{{trans('data.echellon')}}</label>
                                    {!! Form::text('echellon','',["id"=>"echellon","class"=>"form-control",'placeholder'=>"Entrer votre grade",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
								<div class="mb-3">
									<label for="date_nais" class="form-label">{!!trans('data.date_nais')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::date('date_nais',date('Y-m-d'),["id"=>"date_nais","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Date debut" ]) !!}
								</div>
							</div>
                            <div class="col-md-4">
								<div class="mb-3">
									<label for="date_embauche" class="form-label">{!!trans('data.date_embauche')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::date('date_embauche',date('Y-m-d'),["id"=>"date_embauche","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Date debut" ]) !!}
								</div>
							</div>
                            <div class="col-md-8">
                                <div class="mb-3">
