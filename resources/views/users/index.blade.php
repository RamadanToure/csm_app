        ...
        <div class="card"  id="ticketsList">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        @if(in_array('add_user',session('InfosAction')))
                            <a class="btn btn-primary btn-label right rounded-pill" href="{{route('users.create')}}"><i class="ri-add-line label-icon align-middle fs-16 ms-2 rounded-pill"></i>Ajouter</a>
                        @endif
            ...
            <div class="card-body border border-dashed border-end-0 border-start-0">
                {!! Form::open(array('id' => 'formSearch','class' => '', 'method' => 'GET')) !!}
                    ...
                    <div class="row gy-4">
						<!--end col-->
						<!-- <div class="col-xxl-3 col-md-4" <?php  //echo ((!in_array('combo_entite',session('InfosAction'))) ? "style='display:none;'" : '') ?>> 
							<div><label for="labelInput" class="form-label">Liste des entités</label>
								<?php //$addUse = array(''=>'Sélectionnez un élément'); $listEntite_id = $addUse + $listEntite_id->toArray();?>
								{-- !! Form::select('entite_id',$listEntite_id ,session('entite_idSess'),["id"=>"entite_id","onchange"=>"funcRecher()","class"=>"form-select allselect"]) !! --}
							</div>
						</div> -->
