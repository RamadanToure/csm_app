        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <strong><div class="msgAjouter"></div></strong>
                    <form action="{{route('menu.update',$menu->id_menu)}}" method="post" id="form" class="row g-3 needs-validation" novalidate  enctype="multipart/form-data">
                        @csrf()
                        @method('PATCH')
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('libelle_menu',$menu->libelle_menu,["id"=>"libelle_menu","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer le menu",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="titre_page" class="form-label">{{trans('data.titre_page')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::text('titre_page',$menu->titre_page,["id"=>"titre_page","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre titre de la page",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="route" class="form-label">{{trans('data.route')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::text('route',$menu->route,["id"=>"route","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre la route",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="menu_icon" class="form-label">{{trans('data.menu_icon')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::text('menu_icon',$menu->menu_icon,["id"=>"menu_icon","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer votre l'îcone",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="num_ordre" class="form-label">{{trans('data.num_ordre')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::number('num_ordre',$menu->num_ordre,["id"=>"num_ordre","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer le numéro d'ordre",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('topmenu_id',$SltEmpMenu ,$menu->topmenu_id,["id"=>"topmenu_id","class"=>"form-control"]) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="architecture" class="form-label">{{trans('data.architecture')}}<strong style='color: red;'> *</strong></label>
                                    {!! Form::text('architecture',$menu->architecture,["id"=>"architecture","class"=>"form-control","required"=>"required",'placeholder'=>"Entrer le numéro d'ordre",'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
						            ...
						            {!! Form::select('elmt_menu',$addUse ,$menu->elmt_menu,["id"=>"elmt_menu","class"=>"form-select",'required'=>'required']) !!}
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="text-end">
                                    <a href="{{route('menu.index')}}" class="btn btn-outline-dark waves-effect mr-10 rounded-pill">Fermer</a>
