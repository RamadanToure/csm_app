<div class="modal-content">
	<div class="modal-body text-center p-4">
		<div class="mt-2">
			...
			<p class="text-muted mb-4"> Voulez-vous vraiment supprimer cette période {{date('d/m/Y',strtotime($item->date_debut_carr))}} - {{date('d/m/Y',strtotime($item->date_fin_carr))}} ? </p>
			<form  action="{{route('carriere.destroy',$item->id_carr)}}" method="POST">
					@method('DELETE')
					@csrf()
