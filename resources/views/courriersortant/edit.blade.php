		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('courriersortant.update',$item->id_cours)}}" method="post" id="form" class="row g-3 needs-validation" novalidate enctype='multipart/form-data'>
						@csrf()
						@method('PATCH')
							<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::date('date_envoi',$item->date_envoi,["id"=>"date_envoi","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"d/m/Y" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('note_cour',$item->note_cour,["id"=>"note_cour","class"=>"form-control"  ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Note" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="piece_jointe" class="form-label">{!!trans('data.piece_jointe').' '.$item->piece_jointe!!} <strong style='color: red;'> *</strong></label>
									<input class="form-control" type="file" id="piece_jointe" name="piece_jointe" <?php echo isset($item->piece_jointe) ? '' : 'required'; ?> >
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::select('dest_id',$listdest_id ,$item->dest_id,["id"=>"dest_id","class"=>"form-select allselect" ,"required"=>"required"]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
