				...
				<div class="row">
					<div class="col-md-6">
						<div class="mb-3">
							...
							{!! Form::text('code_divi','',["id"=>"code_divi","class"=>"form-control" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Sigle" ]) !!}
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							{!! Form::text('lib_divi','',["id"=>"lib_divi","class"=>"form-control" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Division" ]) !!}
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							{!! Form::select('id_serv',$listid_serv ,session('id_servSess'),["id"=>"id_serv","class"=>"form-select allselect"]) !!}
